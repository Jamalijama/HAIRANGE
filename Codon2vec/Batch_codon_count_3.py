...
#file_name = 'AIV_all_8_before2020_29634_pa'
#res_name = 'before2020_29634_pa'
#file_name = 'IAV_reassortant_1450to2500_new_4_indp_pa'
#res_name = 'IAV_reassortant_indp_pa'
# file_name = 'AIV_all_8_after2020_27016_pa'
# res_name = 'after2020_27016_pa'
# file_name = 'AIV_23366_all_AvianSwine_pa'
# res_name = '23366_all_AvianSwine_pa'
# file_name = 'AIV_reassort_84_pa'
# res_name = 'AIV_reassort_84_pa'
#file_name = 'AIV_all_8_avian_humanH3N2_pa'
#res_name = 'AIV_all_8_avian_humanH3N2_pa'
#file_name = 'H7N9_H5N1_all_4_pa'
#res_name = 'H7N9_H5N1_all_4_pa'
file_name = 'AIV_all_8_avian_humanH1N1_pa'
res_name = 'AIV_all_8_avian_humanH1N1_pa'
    ...
    if file_obj.startswith(file_name) & file_obj.endswith('.csv'):
        ...
        for target_col in target_cols:
            ...
            for seq_i in range(seq_num):
                ...
                if len(count_seq) == seqlen_max[2]:
                    for _ in range(seqlen_opt[2] - seqlen_max[2]):
