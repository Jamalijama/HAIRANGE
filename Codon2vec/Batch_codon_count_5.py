...
#file_name = 'AIV_all_8_before2020_29634_np'
#res_name = 'before2020_29634_np'
#file_name = 'IAV_reassortant_1450to2500_new_4_indp_np'
#res_name = 'IAV_reassortant_indp_np'
# file_name = 'AIV_all_8_after2020_27016_np'
# res_name = 'after2020_27016_np'
# file_name = 'AIV_23366_all_AvianSwine_np'
# res_name = '23366_all_AvianSwine_np'
# file_name = 'AIV_reassort_84_np'
# res_name = 'AIV_reassort_84_np'
#file_name = 'AIV_all_8_avian_humanH3N2_np'
#res_name = 'AIV_all_8_avian_humanH3N2_np'
#file_name = 'H7N9_H5N1_all_4_np'
#res_name = 'H7N9_H5N1_all_4_np'
file_name = 'AIV_all_8_avian_humanH1N1_np'
res_name = 'AIV_all_8_avian_humanH1N1_np'
    ...
    if file_obj.startswith(file_name) & file_obj.endswith('.csv'):
        ...
        for target_col in target_cols:
            ...
            for seq_i in range(seq_num):
                ...
                if len(count_seq) == seqlen_max[3]:
                    for _ in range(seqlen_opt[3] - seqlen_max[3]):
