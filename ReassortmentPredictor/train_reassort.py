...
inputs = np.load('../Res/npy_reassort/array_codon_freq_AIV_all_8_a_hH1N1_aH3N2_0.05_0701_2816.npy', allow_pickle=True)
labels = np.load('../Res/npy/array_label_AIV_all_8_a_hH1N1_aH3N2_0.05_pb2.npy', allow_pickle=True)
...
for j in range(n_splits):
    ...
    for epoch in range(xx * N_EPOCHS, (xx + 1) * N_EPOCHS):
        ...
        torch.save(model.state_dict(), '../Res/pt/resnet_classification_' + str(mdl_batch_size) + '+' + str(
                       lr) + '_' + str(epoch) + '_resnet34_reassort_a_hH1N1_aH3N2_0.05_0701_2816.pt')
...
PrintTrain(x, train_loss_lst, valid_acc_lst,
           '../Res/fig/train_' + str(mdl_batch_size) + '+' + str(lr) + '_resnet34_reassort_a_hH1N1_aH3N2_0.05_0701_2816.png')
PrintROCPRAndCM(trues, preds, probs, pos_label,
                    '../Res/fig/cm_' + str(mdl_batch_size) + '+' + str(lr) + '_resnet34_reassort_a_hH1N1_aH3N2_0.05_0701_2816',
                    '../Res/fig/roc_' + str(mdl_batch_size) + '+' + str(lr) + '_resnet34_reassort_a_hH1N1_aH3N2_0.05_0701_2816.png',
                    '../Res/fig/pr_' + str(mdl_batch_size) + '+' + str(lr) + '_resnet34_reassort_a_hH1N1_aH3N2_0.05_0701_2816.png',
                    '../Res/train_result_data/roc_' + str(mdl_batch_size) + '+' + str(lr) + '_' + str(
                        xx) + '_resnet34_reassort_a_hH1N1_aH3N2_0.05_0701_2816.csv',
                    '../Res/train_result_data/pr_' + str(mdl_batch_size) + '+' + str(lr) + '_' + str(
                        xx) + '_resnet34_reassort_a_hH1N1_aH3N2_0.05_0701_2816.csv')
df1 = pd.DataFrame()
df1['train_loss'] = train_loss_lst
df1['valid_acc'] = valid_acc_lst
df1.to_csv('../Res/train_result_data/train_' + str(mdl_batch_size) + '+' + str(lr) + '_resnet34_reassort_a_hH1N1_aH3N2_0.05_0701_2816.csv',
           index=False)

df1 = pd.DataFrame()
df1['valid_f1'] = valid_f1_lst
df1.to_csv('../Res/train_result_data/valid_f1_' + str(mdl_batch_size) + '+' + str(lr) + '_resnet34_reassort_a_hH1N1_aH3N2_0.05_0701_2816.csv', 
           index=False)
