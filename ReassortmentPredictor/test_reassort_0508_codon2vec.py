...
freq_path = '../Res/npy_reassort/array_codon_freq_IAV_reassortant_indp_0531_2816.npy'
label_path = '../Res/npy/array_label_' + file_name + '_pb2.npy'
id_path = '../Res/npy/array_id_' + file_name + '_pb2.npy'

file_name += '_Codon2Vec_0508_seed17_29'
...
model = ResNet34(2, 11)
model.load_state_dict(torch.load('../Res/pt/resnet_classification_500+0.03_29_resnet34_reassort_ha_sampled5000_Codon2Vec_0508_seed17_2816.pt'))
# model.load_state_dict(torch.load('../Res/pt/resnet_classification_500+0.03_28_resnet34_reassort_ha_sampled5000_0208_2816.pt'))
model.to(device)
...
df.to_csv('../Res/prediction_result_csv/test_500+0.03_10_resnet34_reassort_' + file_name + '_ha_sampled5000_2816.csv', index=False)
