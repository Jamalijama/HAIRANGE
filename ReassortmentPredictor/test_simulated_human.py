...
file_name = 'human_sampled2000_seed7_27016_after2020_reassort'

freq_path = '../Res/npy_reassort/array_codon_freq_' + file_name + '_2816.npy'
...
model = ResNet34(2, 11)
model.load_state_dict(torch.load('../Res/pt/resnet_classification_500+0.03_29_resnet34_reassort_ha_sampled5000_0208_2816.pt'))
model.to(device)
