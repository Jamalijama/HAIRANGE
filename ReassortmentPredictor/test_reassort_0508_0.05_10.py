...
# file_name = 'a_hH1N1_aH3N2_0.05'

# freq_path = '../Res/npy_reassort/array_codon_freq_' + file_name + '_0531_2816.npy'
# label_path = '../Res/npy/array_label_' + file_name + '_pb2.npy'
# id_path = '../Res/npy/array_id_' + file_name + '_pb2.npy'

file_name = 'ha_sampled5000'

freq_path = '../Res/npy_reassort/array_codon_freq_' + file_name + '_0508_2816.npy'
label_path = '../Res/npy/array_label_' + file_name + '_pb2.npy'
id_path = '../Res/npy/array_id_' + file_name + '_pb2.npy'
...
file_name += '_Codon2Vec_0508_0.05_H3_V3_'
...
label_lst = []
pred_lst = [pred_ for pred_ in pred]
prob_lst = [prob_ for prob_ in prob1]
...
df.to_csv('../Res/prediction_result_csv/test_500+0.03_10_resnet34_reassort_' + file_name + 'a_hH1N1_aH3N2_0.05_0508_2816.csv', index=False)
