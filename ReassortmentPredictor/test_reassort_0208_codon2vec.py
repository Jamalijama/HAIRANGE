...
model = ResNet34(2, 11)
model.load_state_dict(torch.load('../Res/pt/resnet_classification_ha_sampled5000_Codon2vec_500+0.03_resnet34.pt'))
...
df.to_csv('../Res/prediction_result_csv/test_500+0.03_10_resnet34_reassort_' + file_name + '_ha_sampled5000_0507_2816.csv', index=False)
