...
# load data
file_name = 'human_sampled2000_seed7_27016_after2020_reassort_2816'
freq_path = '../Res/npy_reassort/humanH3N2_AvianSwine_simulated_' + file_name + '.npy'
id_path = '../Res/res1/humanH3N2_AvianSwine_simulated_name_' + file_name + '.csv'
...
df['prob'] = probs_lst
# cds1
df.to_csv('../Res/prediction_result_csv/humanH3N2_simulated' + file_name + '.csv', index=False)
