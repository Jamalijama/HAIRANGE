        ...
        for lr in lr_lst:
            ...
            for j in range(n_splits):
                ...
                PrintROCPRAndCM(true, pred, pos_probs, pos_label,
                                '../Res/fig/cm_' + cds[i] + '_' + str(mdl_batch_size) + '+' + str(lr) + '_' + str(
                                    xx) + '_resnet34' + dir[i] + '.png',
                                '../Res/fig/roc_' + cds[i] + '_' + str(mdl_batch_size) + '+' + str(lr) + '_' + str(
                                    xx) + '_resnet34' + dir[i] + '.png',
                                '../Res/fig/pr_' + cds[i] + '_' + str(mdl_batch_size) + '+' + str(lr) + '_' + str(
                                    xx) + '_resnet34' + dir[i] + '.png',
                                '../Res/train_result_data/roc_' + cds[i] + '_' + str(mdl_batch_size) + '+' + str(
                                    lr) + '_' + str(xx) + '_resnet34' + dir[i] + '.csv',
