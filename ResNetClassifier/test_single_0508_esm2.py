...
# for i in range(2, 3):
    ...
    # new_AIV_all_8_ha_indp_pb2_protein_emb_esm2_array_0503_ordered
    freq_path = '../Res/model_evaluate/ESM2_05/new_AIV_all_8_ha_' + file_name + '_protein_emb_esm2_array_0503_ordered.npy'
    ...
    model.load_state_dict(
        torch.load('../Res/pt/resnet_classification_ha_sampled5000_' + cds[i] + '_ESM2_05_1150+0.03_resnet34.pt'))
    ...
    df.to_csv('../Res/prediction_result_csv/test_' + file_name + '_ESM2_05_1150+0.03_resnet34.csv',
              index=False)
