...
# for i in range(1, 3):
    ...
    model.load_state_dict(
        torch.load('../Res/pt/resnet_classification_' + file_name + '_lucaOne_1150+0.03_resnet34.pt'))
    # '../Res/pt/resnet_classification_' + file_name + '_lucaOne_' + str(mdl_batch_size) + '+' + str(lr) + '+' + str(N_EPOCHS * n_splits) + '_resnet34.pt')
    model.to(device)
    
    file_name += '_protein_lucaone_0507_30'
    # file_name += '_protein_lucaone_0507_30_label1'
