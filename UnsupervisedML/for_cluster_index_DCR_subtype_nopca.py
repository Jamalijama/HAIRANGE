...
# for i in range(0,1):
    ...
    #
    df_evaluation.to_csv('../Res/model_evaluate/DCR/df_evaluate_cluster_' + res_name + '_noPCA.csv')
    ...
    # df_new.to_csv('../Res/model_evaluate/DCR/PCA_result_with_MiniBatchKMeans_label_' + res_name + '.csv')
