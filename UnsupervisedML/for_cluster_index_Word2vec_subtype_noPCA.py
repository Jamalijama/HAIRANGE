...
#        pickle.dump(inputs2, f2)
    ...
    inputs = np.array(df_new['emb'].tolist())
    ...
    #
    df_evaluation.to_csv('../Res/model_evaluate/Word2vec/df_evaluate_cluster_' + res_name + '_noPCA.csv')
    ...
    # df_new.to_csv('../Res/model_evaluate/Word2vec/PCA_result_with_MiniBatchKMeans_label_' + res_name + '.csv')
