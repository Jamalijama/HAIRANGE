...
umap = umap.UMAP(n_neighbors=0.5, n_components=2, random_state=7, min_dist=0.5)
...
df_1['label'] = label
df_1.to_csv('../Res/trm_feature_csv/features_before_trm_' + file_name + '_0.5+0.5.csv', index=False)
...
df_2['label'] = label
df_2.to_csv('../Res/trm_feature_csv/features_after_trm_' + file_name + '_0.5+0.5.csv', index=False)
