...
# for i in range(0,1):
    ...
    word_dim = 64
    np.random.seed(42)
    matrix_npy = np.random.rand(2000, len_lst[i], word_dim)
    # matrix_npy = np.load('../Res/npy/array_codon_freq_' + res_name + '.npy', allow_pickle=True)
    ...
    #
    df_evaluation.to_csv('../Res/model_evaluate/random/df_evaluate_cluster_' + res_name + '_noPCA.csv')
    ...
    # df_new.to_csv('../Res/model_evaluate/random/PCA_result_with_MiniBatchKMeans_label_' + res_name + '.csv')
    ...
    # plt.savefig('../Res/model_evaluate/random/sns_scatterplot_PCA_' + res_name + '.png', dpi=300, bbox_inches='tight')
