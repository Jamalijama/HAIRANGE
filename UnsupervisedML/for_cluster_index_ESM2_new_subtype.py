...
# for i in range(0,1):
    ...
    #
    df_evaluation.to_csv('../Res/model_evaluate/ESM2_05/df_evaluate_cluster_' + res_name + '_PCA.csv')
    ...
    df_new.to_csv('../Res/model_evaluate/ESM2_05/PCA_result_with_MiniBatchKMeans_label_' + res_name + '.csv')
    ...
    plt.savefig('../Res/model_evaluate/ESM2_05/sns_scatterplot_PCA_' + res_name + '.png', dpi=300, bbox_inches='tight')
