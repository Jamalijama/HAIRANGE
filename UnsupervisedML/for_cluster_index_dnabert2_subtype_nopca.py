...
# for i in range(0,1):
    ...
    maxlen = len_lst[i]
    word_dim = 768
    matrix_npy = np.load('../Res/model_evaluate/DNABERT2/new_AIV_all_8_' + res_name + '_gene_emb_dnabert2_array_0503_ordered.npy', allow_pickle=True)
    ...
    # ac_cluster_1_pred = AgglomerativeClustering(n_clusters=2, linkage='complete').fit_predict(reshape_composition_array)
    # # 聚类效果评价
    ...
    #
    df_evaluation.to_csv('../Res/model_evaluate/DNABERT2/df_evaluate_cluster_' + res_name + '_0503_noPCA.csv')
    ...
    # df_new.to_csv('../Res/model_evaluate/DNABERT2/PCA_result_with_MiniBatchKMeans_label_' + res_name + '_0503.csv')
    ...
    # plt.savefig('../Res/model_evaluate/DNABERT2/sns_scatterplot_PCA_' + res_name + '_0503.png', dpi=300, bbox_inches='tight')
