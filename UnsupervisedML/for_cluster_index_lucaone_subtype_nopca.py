...
# for i in range(0,1):
    ...
    maxlen = len_lst[i]
    word_dim = 2560
    matrix_npy = np.load('../Res/model_evaluate/lucaOne/new_AIV_all_8_' + res_name + '_protein_emb_lucaone_array_0503_ordered.npy', allow_pickle=True)
    ...
    #
    df_evaluation.to_csv('../Res/model_evaluate/lucaOne/df_evaluate_cluster_' + res_name + '_0503_noPCA.csv')
    ...
    # df_new.to_csv('../Res/model_evaluate/lucaOne/PCA_result_with_MiniBatchKMeans_label_' + res_name + '_0503.csv')
    ...
    # plt.savefig('../Res/model_evaluate/lucaOne/sns_scatterplot_PCA_' + res_name + '_0503.png', dpi=300, bbox_inches='tight')
