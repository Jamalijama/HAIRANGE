...
#matrixs = np.load('../Res/model_evaluate/ESM2_05/new_AIV_all_8_ha_sampled1000_pb1_protein_emb_esm2_array_ordered.npy', allow_pickle=True)
#
#print(matrixs.shape)